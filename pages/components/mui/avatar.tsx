...
import Avatar from '@/_global/components/Avatar';
          ...
          <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
            ...
            >
              {[1, 2, 3, 4, 5].map((_, index) => (
                <Avatar
                  key={index}
                  alt="Remy Sharp"
                  src={`https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/avatars/avatar_${
                    index + 1
                  }.jpg`}
                />
              ))}
            ...
            >
              <AvatarGroup max={4}>
                <Avatar
                  alt="Remy Sharp"
                  src="https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/avatars/avatar_4.jpg"
                />
                <Avatar color="info">OP</Avatar>
                <Avatar
                  alt="Cindy Baker"
                  src="https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/avatars/avatar_5.jpg"
                />
                <Avatar
                  alt="Agnes Walker"
                  src="https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/avatars/avatar_6.jpg"
                />
                <Avatar
                  alt="Trevor Henderson"
                  src="https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/avatars/avatar_7.jpg"
                />
                <Avatar
                  alt="Trevor Henderson"
                  src="https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/avatars/avatar_8.jpg"
                />
                <Avatar
                  alt="Trevor Henderson"
                  src="https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/avatars/avatar_9.jpg"
                />
              </AvatarGroup>
            </Block>
