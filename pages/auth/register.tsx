          ...
          {mdUp && (
            <SectionStyle>
              <Typography variant="h3" sx={{ px: 5, mt: 10, mb: 5 }}>
                Manage the device more effectively with SofttealIOT
              </Typography>
              <Image
                visibleByDefault
                disabledEffect
                alt="register"
                src="/global-assets/assets/illustrations/illustration_dashboard.png"
              />
            </SectionStyle>
          )}
          ...
          <Container>
            <ContentStyle>
              ...
              <Typography variant="body2" align="center" sx={{ color: 'text.secondary', mt: 3 }}>
                By registering, I agree to SofttealIOT&nbsp;
