...
export const _carouselsMembers = [...Array(5)].map((_, index) => ({
  ...
  avatar: `https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/members/member-${index + 1}.jpg`,
}));
...
export const _organizations = [...Array(5)].map((_, index) => ({
  id: _mock.id(index),
  name: _mock.name.fullName(index),
