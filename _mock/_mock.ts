...
const _mock = {
  ...
  image: {
    cover: (index: number) =>
      `https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/covers/cover_${index + 1}.jpg`,
    feed: (index: number) =>
      `https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/feeds/feed_${index + 1}.jpg`,
    product: (index: number) =>
      `https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/products/product_${index + 1}.jpg`,
    avatar: (index: number) =>
      `https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/avatars/avatar_${index + 1}.jpg`,
  },
};
