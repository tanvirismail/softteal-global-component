...
export const _appRelated = ['Chrome', 'Drive', 'Dropbox', 'Evernote', 'Github'].map(
  (appName, index) => ({
    ...
    shortcut: `https://minimal-assets-api-dev.vercel.app/global-assets/assets/icons/ic_${noCase(appName)}.svg`,
  })
);
...
export const _appInstalled = ['de', 'en', 'fr', 'kr', 'us'].map((country, index) => ({
  ...
  flag: `/global-assets/assets/icons/flags/ic_flag_${country}.svg`,
}));
