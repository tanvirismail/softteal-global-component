...
import { CarouselDots } from '@/_global/components/carousel';
...
const CardItemStyle = styled('div')(({ theme }) => ({
  ...
  backgroundImage: 'url("/global-assets/assets/bg_card.png")',
  display: 'flex',
    ...
    <CardItemStyle>
      ...
      <Stack direction="row" alignItems="center" justifyContent="flex-end" spacing={1}>
        <Image
          ...
          visibleByDefault
          alt="credit-card"
          src={`https://minimal-assets-api-dev.vercel.app/global-assets/assets/icons/ic_${
