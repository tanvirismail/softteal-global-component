...
// utils
import { fDateTime } from '@/_global/utils/formatTime';
// components
...
export default function WidgetSlider({ title, subheader, list, sx, ...other }: Props) {
  ...
  return (
    <Paper sx={{ mx: 1.5, borderRadius: 2, bgcolor: 'background.neutral' }}>
      ...
      <Box sx={{ p: 1, position: 'relative' }}>
        ...
        <Image alt="cover" src={cover} ratio="4/3" sx={{ borderRadius: 1.5 }} />
      </Box>
    </Paper>
  );
}
