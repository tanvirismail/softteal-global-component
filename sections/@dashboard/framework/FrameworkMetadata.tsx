...
import {
  ...
  import qs from 'qs';
import MetadataDialog from "./dialog/MetadataDialog";
  


export default function FrameworkMetadata() {
    ...
    return (
        <>
            ...
            <MetadataDialog open={datastreamDialog} setOpen={setDatastreamDialog}/>
            <Datatable
                customToolbar={
