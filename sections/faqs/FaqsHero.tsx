...
import InputStyle from '@/_global/components/InputStyle';
import { MotionContainer, TextAnimate, varFade } from '@/_global/components/animate';
...
const RootStyle = styled('div')(({ theme }) => ({
  ...
  backgroundImage:
    'url(/global-assets/assets/overlay.svg), url(https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/faqs/hero.jpg)',
