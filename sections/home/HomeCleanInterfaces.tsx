...
const IMG = [...Array(10)].map(
  (_, index) =>
    `https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/home/clean-${index + 1}.png`
);
          ...
          {IMG.map((_, index) => (
            ...
            >
              <Image
                ...
                visibleByDefault
                alt={`clean-${index + 1}`}
                src={`https://minimal-assets-api-dev.vercel.app/global-assets/assets/images/home/clean-${
                  index + 1
                }.png`}
              />
            </Box>
