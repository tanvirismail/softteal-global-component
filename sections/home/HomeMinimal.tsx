...
const CARDS = [
  {
    icon: 'https://minimal-assets-api-dev.vercel.app/global-assets/assets/icons/ic_design.svg',
    title: 'UI & UX Design',
    description:
      'The set is built on the principles of the atomic design system. It helps you to create projects fastest and easily customized packages for your projects.',
  },
  {
    icon: 'https://minimal-assets-api-dev.vercel.app/global-assets/assets/icons/ic_code.svg',
    title: 'Development',
    description: 'Easy to customize and extend each component, saving you time and money.',
  },
  {
    icon: '/global-assets/logo/logo_single.svg',
    title: 'Branding',
